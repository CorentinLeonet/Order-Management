...
@orders_bp.route("/articles/<int:article_id>")
...
@orders_bp.route("/articles/new", methods=["GET", "POST"])
def create():
...
@orders_bp.route("/articles/<int:article_id>/edit")
...
@orders_bp.route("/articles/<int:article_id>/update", methods=["POST"])
...
@orders_bp.route("/articles/<int:article_id>/delete", methods=["POST"])
